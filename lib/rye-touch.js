(function($){
    ...
    if ('ontouchstart' in window) {
        ...
        var tap = new Gesture({
          ...
          , swipe = new Gesture({
              ...
              , trigger: function () {
                    ...
                    touch.element.trigger('swipe' + this.direction().toLowerCase())
                    touch.element.trigger('swipe' + this.direction())
                    touch = {}
                }
              , direction: function () {
        ...
        doc.on('touchcancel', Gesture.cancelAll)
        doc.on('scroll', Gesture.cancelAll)

        // exports events
        ;['swipe', 'swipeLeft', 'swipeRight', 'swipeUp', 'swipeDown', 'doubleTap', 'tap', 'singleTap', 'longTap'].forEach(function(event){
